...
const DEFAULT_TAGS = ["8-bit","accordian","adventure","ambient","battle","beautiful","boss","brass","cave","celebration","cheery","chiptune","choir","circus","cover","credits","creepy","depressing","dark","day","disco","distant","dynamic","electronic","emotional","empty","fall","fast","finale","foreboding","frantic","gambling","game over","gentle","glitch","guitar","happy","hardcore","harp","heavy","heroic","hip hop","horror","insane","intense","jazz","joyful","latin","lullaby","march","medley","mellow","meloncholy","menu","metal","minimal","music box","mysterious","night","nostalgic","orchestrated","organ","piano","pop","powerful","rave","relaxing","remix","rock","romantic","saxophone","secret","sfx","shop","slow","snow","soft","space","spring","strings","summer","synth","tropical","trumpet","underwater","upbeat","violin","vocals","volcano","waltz","weird","western","winter","woodwind"]
